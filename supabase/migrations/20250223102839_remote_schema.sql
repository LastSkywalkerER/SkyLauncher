...
ALTER TABLE ONLY "public"."versions"
    ADD CONSTRAINT "versions_modpack_name_key" UNIQUE ("modpack_name");
...
GRANT ALL ON SEQUENCE "public"."modpacks_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."modpacks_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."modpacks_id_seq" TO "service_role";
